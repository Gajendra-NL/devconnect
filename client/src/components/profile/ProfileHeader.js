          ...
          <div className="card card-body bg-info text-white mb-3">
            ...
            <div className="text-center">
              ...
              <p>
                ...
                {isEmpty(profile.facebook && profile.social.facebook) ? null :
                  <a className="text-white p-2" href={profile.social.facebook} target="_blank">
                    <i className="fab fa-facebook fa-2x"></i>
                  </a>
                }
                {isEmpty(profile.linkedin && profile.social.linkedin) ? null :
                  <a className="text-white p-2" href={profile.social.linkedin} target="_blank">
                    <i className="fab fa-linkedin fa-2x"></i>
                  </a>
                }
                {isEmpty(profile.instagram && profile.social.instagram) ? null :
